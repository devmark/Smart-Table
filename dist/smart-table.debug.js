...
(function(ng, undefined) {
  ...
  ng.module('smart-table')
    .controller('stTableController', ['$scope', '$parse', '$filter', '$attrs', function StTableController($scope, $parse, $filter, $attrs) {
      ...
      this.setPagination = function splice(currentPage, action) {
        tableState.pagination.currentPage = currentPage;
        tableState.pagination.action = action;
        return this.pipe();
      };
    ...
    .directive('stNextPrevPagination', function() {
      return {
        ...
        link: function(scope, element, attrs, ctrl) {
          ...
          function redraw() {
            var paginationState = ctrl.tableState().pagination;
            scope.currentPage = paginationState.currentPage;
            scope.cantPageBackward = scope.currentPage <= 1;
            scope.cantPageForward = paginationState.cantPageForward;
          }

          scope.prev = function() {
            scope.currentPage = Math.max(scope.currentPage - 1, 1);
            ctrl.setPagination(scope.currentPage, 'prev');
          };
          scope.next = function() {
            scope.currentPage += 1;
            ctrl.setPagination(scope.currentPage, 'next');
          };
